---
title: Hero Banner
description: A full-width banner with a background image overlay, headline, subtext, and CTA buttons.
slug: /recipes/hero-banner
---
...
<RecipePreview>
  <div className="recipe-hero-wrap">
    <div className="recipe-hero">
      <lt-badge content="Now available" class="recipe-hero-badge" />
      <lt-text variant="display-lg" as="h1" class="recipe-hero-title">
        Build faster with Latty
      </lt-text>
      <lt-text variant="lead" class="recipe-hero-sub">
        Design tokens and Web Components that work natively in any framework.
      </lt-text>
      <div className="recipe-hero-actions">
        <lt-button variant="primary" size="lg">
          Get started
        </lt-button>
        <lt-button class="recipe-hero-outline" variant="neutral" appearance="outlined" size="lg">
          View docs
        </lt-button>
      </div>
    </div>
...
react={`import { Badge, Text, Button } from '@latty-ds/react';
...
<code>lt-badge</code>, <code>lt-text</code>, <code>lt-button</code>
