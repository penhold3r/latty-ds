---
title: Stats Widget
description: A dashboard metrics panel with icon, value, label, and progress bar for each stat.
slug: /recipes/stats-widget
---
...
<RecipePreview>
  <lt-surface appearance="outlined" elevation="0" style={{ maxWidth: 460, width: '100%' }}>
    <div style={{ padding: 'var(--lt-spacing-6)' }}>
      <lt-text variant="h5" style={{ marginBottom: 'var(--lt-spacing-5)' }}>
        Overview
      </lt-text>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--lt-spacing-5)' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--lt-spacing-2)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--lt-spacing-2)' }}>
            <lt-icon name="chart" style={{ color: 'var(--lt-color-success-500)' }} />
            <lt-text variant="body-sm" class="text-muted">
              Revenue
            </lt-text>
          </div>
          <lt-text variant="h3">$24.5k</lt-text>
          <lt-progress value="72" variant="success" label="Revenue: 72%" />
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--lt-spacing-2)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--lt-spacing-2)' }}>
            <lt-icon name="user" style={{ color: 'var(--lt-color-primary-500)' }} />
            <lt-text variant="body-sm" class="text-muted">
              Users
            </lt-text>
          </div>
          <lt-text variant="h3">1,284</lt-text>
          <lt-progress value="58" variant="primary" label="Users: 58%" />
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--lt-spacing-2)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--lt-spacing-2)' }}>
          ...
          <lt-text variant="h3">94%</lt-text>
          <lt-progress value="94" variant="success" label="Tasks done: 94%" />
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--lt-spacing-2)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--lt-spacing-2)' }}>
            <lt-icon name="warning-triangle" style={{ color: 'var(--lt-color-warning-500)' }} />
            <lt-text variant="body-sm" class="text-muted">
              Issues
            </lt-text>
          </div>
          <lt-text variant="h3">12</lt-text>
          <lt-progress value="24" variant="warning" label="Issues: 24%" />
        </div>
      </div>
    </div>
  </lt-surface>
...
<FrameworkTabs
  html={`<lt-surface appearance="outlined" elevation="0" style="max-width: 460px; width: 100%;">
  <div style="padding: var(--lt-spacing-6);">
  ...
  react={`import { Surface, Icon, Text, Progress } from '@latty-ds/react';
...
<code>lt-surface</code>, <code>lt-icon</code>, <code>lt-text</code>, <code>lt-progress</code>
