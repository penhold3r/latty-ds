...
<VariantPresets tag="lt-button" slotContent="Button" />
...
<code>lt-button</code> is form-associated. Set <code>type="submit"</code> to submit the containing form (with constraint
validation) or <code>type="reset"</code> to reset it.
