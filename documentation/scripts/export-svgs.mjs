...
// Ported verbatim from docs/scripts/export-svgs.mjs (the Astro site) — pure
// Node + JSZip, framework-agnostic. Only change: outDir now points at
// documentation/static/assets instead of docs/public/assets.
...
const outDir = resolve(root, 'documentation/static/assets');
