---
title: Content Card
description: A media card with image, category badge, title, excerpt, and a call-to-action button.
slug: /recipes/content-card
---

import RecipePreview from '@site/src/components/RecipePreview';
import FrameworkTabs from '@site/src/components/FrameworkTabs';
import './content-card.styles.css';
...
<RecipePreview>
  <lt-surface class="content-card" appearance="outlined" elevation="1" style={{ maxWidth: 300, display: 'block' }}>
    <img
    ...
    >
      <lt-badge content="Design" />
      <lt-text variant="h5">Building with design tokens</lt-text>
      ...
      <lt-button variant="primary" size="sm" appearance="outlined">
        Read more
      </lt-button>
    </div>
  </lt-surface>
...
<FrameworkTabs
  html={`<lt-surface class="content-card" appearance="outlined" elevation="1" style="max-width: 300px; display: block;">
  <img
    src="https://picsum.photos/seed/content-card/600/360"
    alt="Card cover"
...
react={`import { Surface, Badge, Text, Button } from '@latty-ds/react';
...
<code>lt-surface</code>, <code>lt-badge</code>, <code>lt-text</code>, <code>lt-button</code>
