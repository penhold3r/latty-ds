...
<ComponentPlayground
  tag="lt-list"
  content={
    '<lt-list-item icon-start="check">First item</lt-list-item><lt-list-item icon-start="clock">Second item</lt-list-item><lt-list-item icon-start="info-circle">Third item</lt-list-item>'
  }
  previewHeight="140px"
