...
| `appearance`                  | Visual fill style                                                   | `filled`, `outlined`, `ghost`, `solid`, `clean`, `dashed`, `dotted`                    | Button, Badge, Alert, Chip, Surface, Dialog, Snackbar, Divider, Accordion, Tab group… |
| `elevation`                   | Shadow depth                                                        | `'0'`–`'5'`                                                                            | Surface, Dialog, Snackbar                                                             |
| `bordered`                    | Adds a variant-colored border on top of the current appearance      | boolean                                                                                | Button, IconButton                                                                    |
